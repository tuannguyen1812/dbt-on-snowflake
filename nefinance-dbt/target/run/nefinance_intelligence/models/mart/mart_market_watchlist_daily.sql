        ...
        create or replace transient table NEFINANCE_DB.DEV.mart_market_watchlist_daily
         as
        (select * from (
...
left join news_by_date
    on prices.price_date = news_by_date.published_date
      ...
      alter  table NEFINANCE_DB.DEV.mart_market_watchlist_daily cluster by (price_date, ticker);
