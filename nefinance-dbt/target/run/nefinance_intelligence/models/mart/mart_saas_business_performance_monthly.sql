        ...
        create or replace transient table NEFINANCE_DB.PROD.mart_saas_business_performance_monthly
         as
        (select * from (
...
left join churn_monthly
    on revenue_monthly.performance_month = churn_monthly.performance_month
      ...
      alter  table NEFINANCE_DB.PROD.mart_saas_business_performance_monthly cluster by (performance_month);
